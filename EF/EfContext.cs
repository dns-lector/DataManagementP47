...
/* Д.З. За допомогою Entity Framework ініціалізувати та сідувати БД
 * Додати до кожної з таблиць (Фірми, Товари, Співробітники) по декілька
 * записів: Фірми +2, Співробітники +4-7 на кожну фірму, товари +5
 * (Після змін у контексті необхідно створювати та впроваджувати міграцію)
 */